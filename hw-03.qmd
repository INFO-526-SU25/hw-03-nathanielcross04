...
```{r}
#| label: Q5 code diverging bar plot
...
covid_q51_summary |>
  ...
  labs(
    y = NULL, 
    x = "Mean Likert scale response\n1 (Strongly agree) to 5 (Strongly disagree)",
    title = "Already-vaccinated students more confident\nin safety of COVID-19 vaccine",
    caption = "Source: Pavan Shah, Giorgio Caturegli, Galen Shi, and Joshua Materi | Johns Hopkins School of Medicine"
  ) +
  scale_x_continuous(
    labels = abs,
    limits = c(-5, 5),
